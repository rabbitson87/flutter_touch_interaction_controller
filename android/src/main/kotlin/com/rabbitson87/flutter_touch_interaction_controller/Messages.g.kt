...
data class Version (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): Version {
      val string = list[0] as String?
...
interface MessageApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: MessageApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.MessageApi.getPlatformVersion", codec)
        if (api != null) {
